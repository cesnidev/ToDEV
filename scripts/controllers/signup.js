...
calcomm.controller('SignUpCtrl', function($rootScope,$scope,CalcommResource,cssInjector,$window,Session,$location,CalcommConfig,CalcommLogin,upload,CalcommUtils) {
...
//											console.log("contenido image:"+$scope.basicinfo.profile_picture.body)
